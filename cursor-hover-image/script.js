...
// Function to convert time from EST to IST
function convertESTtoIST(ESTtime) {
    var ESTdate = new Date();
    var parts = ESTtime.split(':');
    ESTdate.setHours(parseInt(parts[0], 10));
    ESTdate.setMinutes(parseInt(parts[1], 10));
    ESTdate.setSeconds(parseInt(parts[2], 10));
    var ISTdate = new Date(ESTdate.toLocaleString("en-US", {timeZone: "Asia/Kolkata"}));
    return ISTdate.toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'});
}

// Set EST time
var estTime = "0:05:00 AM";

// Convert EST to IST
var istTime = convertESTtoIST(estTime);
